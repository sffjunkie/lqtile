...
from ..color.convert import opacity_to_str
from ..model.default import DEFAULT_FONT_SIZE, DEFAULT_BAR
...
class BarContext:
    ...
    def __init__(
        ...
        if bar_props is None:
            bar_props = DEFAULT_BAR[self.position]
